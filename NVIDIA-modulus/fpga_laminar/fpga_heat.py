...
def run(cfg: ModulusConfig) -> None:
    ...
    thermal_nodes = (
        ...
        + [thermal_f_net.make_node(name="thermal_f_network", jit=cfg.jit)]
        + [thermal_s_net.make_node(name="thermal_s_network", jit=cfg.jit)]
    )
    ...
    openfoam_flow_validator = PointwiseValidator(
        openfoam_invar_numpy, openfoam_thermal_outvar_numpy, thermal_nodes
    )
    ...
    openfoam_solid_validator = PointwiseValidator(
        openfoam_invar_solid_numpy, openfoam_outvar_solid_numpy, thermal_nodes
    )
    thermal_domain.add_validator(
