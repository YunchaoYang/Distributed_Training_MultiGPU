...
#TRAINING_CMD="$(realpath "unet_training_workflows_slurm.py")"
TRAINING_CMD="$(realpath "/mnt/unet_training_ddp_slurm.py")" # any other arguments
...
PT_LAUNCH_SCRIPT="${PT_LAUNCH_UTILS_PATH}/run_on_node.sh"
