...
#TRAINING_SCRIPT="$(realpath "/red/ufhpc/hityangsir/MultiNode_MONAI_example/unet_training_workflows_slurm.py")"

#TRAINING_SCRIPT="$(realpath "/mnt/unet_training_workflows_slurm.py")"

TRAINING_SCRIPT="$(realpath "/mnt/unet_training_ddp_slurm.py")"
...
#PYTHON_PATH="singularity exec --nv /blue/vendor-nvidia/hju/torch1.9.0 python3"       
PYTHON_PATH="singularity exec --nv --bind /red/ufhpc/hityangsir/MultiNode_MONAI_example:/mnt  /red/ufhpc/hityangsir/MultiNode_MONAI_example/pyt21.07 python3"       
