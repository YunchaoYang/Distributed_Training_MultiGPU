# https://tuni-itc.github.io/wiki/Technical-Notes/Distributed_dataparallel_pytorch/#acknowledgements
...
def train(gpu, args):
    ...
    print('node: ' + os.environ.get("SLURM_NODEID") + ' gpu: ' + str(args.gpu) + ' rank: ' + str(rank))
...
if __name__ == "__main__":
    ...
    print("master ip_adress is", args.ip_adress)
